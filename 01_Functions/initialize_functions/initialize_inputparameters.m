...
vehicle.Input.eta_gearbox_r             =   [0.9, 0.8, 0.7];            %efficiency of rear gearbox, optional
vehicle.Input.eta_gearbox_f             =   [0.9, 0.8, 0.7];            %efficiency of front gearbox, optional
