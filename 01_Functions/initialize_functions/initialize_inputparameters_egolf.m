function [vehicle,Parameters] = initialize_inputparameters_egolf(vehicle)
...
vehicle.Input.vehicle_empty_weight      =   1450 + 75;      %empty weight netto in kg (no driver) %1400 / 1698.2-75
