...
vehicle.Input.vehicle_empty_weight      =   1205;           %empty weight netto in kg (no driver) 1205 / 1443.3 -75
...
vehicle.Input.driving_cycle             =   'bmwi3_d3_021';         %driving cycle (cycle are in folder 04_Drive_Cycle)
...
vehicle.Input.i_gearbox_r               =   [9.7];         %gear ratio rear
...
vehicle.Input.c_r                       =   0.006;            %roll resistance coefficient, (optional)
vehicle.Input.c_d                       =   0.29;            %air resistance coefficient, (optional)
vehicle.Input.eta_gearbox_r             =   [0.965];            %efficiency of rear gearbox, optional
...
Parameters.LDS.eta_gearbox              =   0.965;       %efficiency of gearbox in [-]. Source [6]
