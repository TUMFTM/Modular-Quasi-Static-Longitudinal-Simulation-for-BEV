...
vehicle.Input.vehicle_empty_weight      =   2133;           %empty weight netto in kg (no driver)
...
vehicle.Input.i_gearbox_f               =   9.06;          %gear ratio front
vehicle.Input.i_gearbox_r               =   9.06;         %gear ratio rear
...
vehicle.Input.eta_gearbox_r             =   0.98;            %efficiency of rear gearbox, optional
vehicle.Input.eta_gearbox_f             =   0.98;            %efficiency of front gearbox, optional
