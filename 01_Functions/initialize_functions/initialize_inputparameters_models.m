...
%% Description: Tesla Model S P85D
...
vehicle.Input.vehicle_empty_weight      =   2241;           %empty weight netto in kg (no driver)
...
vehicle.Input.T_max_Mot_r               =  600;         %max torque of rear machine in Nm
