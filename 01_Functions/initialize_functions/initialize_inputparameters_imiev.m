...
%% Description: Mitsubishie i-Miev
...
vehicle.Input.vehicle_empty_weight      =   1304-75;        %empty weight netto in kg (no driver)
...
vehicle.Input.driving_cycle             =   'US_HIGHWAY';         %driving cycle (cycle are in folder 04_Drive_Cycle)
...
vehicle.Input.T_max_Mot_r               =  196;         %max torque of rear machine in Nm
...
Parameters.LDS.eta_differential         =   0.94;      %efficiency of differential in [-]. Source [5]
Parameters.LDS.eta_gearbox              =   0.94;       %efficiency of gearbox in [-]. Source [6]
Parameters.LDS.correction_gearbox       =   1/1.1056;       %correction factor for gear ratio (for electric vehicles) in [-]. Source [3]
