...
%% Description:
%For the sim_acc the torque is automatically scaled according to the
...
%Author: Lorenzo Nicoletti, FTM
%date:   30.12.2019
%% Input:
%vehicle struct
%% Outputs:
%vehicle struct with scaled torque (if a scaling is required)
%% Implementation:
